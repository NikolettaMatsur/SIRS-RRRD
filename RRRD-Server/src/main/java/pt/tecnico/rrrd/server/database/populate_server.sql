...
CREATE TABLE IF NOT EXISTS permissions(id int AUTO_INCREMENT PRIMARY KEY, file_id int NOT NULL,  username varchar(30) NOT NULL,  pub_key_id int NOT NULL, permission_key varchar(4096) NOT NULL);